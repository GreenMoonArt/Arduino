 ...
 * 5 NeoPixel LED strips of 8 LEDs each connected to an Arduino. 
 * Random functions are used to activate individual strips. 
 * Looked good when the 5 strips were spaced out on tree branches. 
 */
...
//edit this to reflect how many neopixel strips you are using: 
